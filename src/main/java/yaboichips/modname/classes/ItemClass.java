...
public class ItemClass {
    ...
    public static void registerItems(final RegistryEvent.Register<Item> event) {
        event.getRegistry().registerAll(
                ...
                (new ArmorItem(Flannel.TEST, EquipmentSlotType.HEAD, new Item.Properties().group(ModName.JUNKTAB)).setRegistryName("flannel_helmet")),
                (new ArmorItem(Flannel.TEST, EquipmentSlotType.CHEST, new Item.Properties().group(ModName.JUNKTAB)).setRegistryName("flannel_chestplate")),
    ...
    public enum Flannel implements IArmorMaterial {
        TEST(ModName.MODID + ":flannel", 5, new int[]{1, 2, 3, 1}, 9, SoundEvents.ITEM_ARMOR_EQUIP_LEATHER, 0f, () -> {
