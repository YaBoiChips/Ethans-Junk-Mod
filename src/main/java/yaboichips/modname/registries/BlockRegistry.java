...
import yaboichips.modname.classes.BlockProperties;
import yaboichips.modname.classes.Saplings;
import yaboichips.modname.lists.BlockList;
import yaboichips.modname.world.feature.trees.hardwood.HardwoodTree;
...
public class BlockRegistry {
    ...
    public static void registerBlocks(final RegistryEvent.Register<Block> event) {
        ...
        ModName.LOGGER.info("Blocks registered");
    }
}