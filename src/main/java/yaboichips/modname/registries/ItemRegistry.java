...
public class ItemRegistry {
    ...
    public static void registerItems(final RegistryEvent.Register<Item> event) {
        event.getRegistry().registerAll(
                ...
                ItemList.blue_concrete_stair = new BlockItem(BlockList.blue_concrete_stair, new Item.Properties().group(ModName.JUNKTAB)).setRegistryName(BlockList.blue_concrete_stair.getRegistryName()),
                ItemList.light_blue_concrete_stair = new BlockItem(BlockList.light_blue_concrete_stair, new Item.Properties().group(ModName.JUNKTAB)).setRegistryName(BlockList.light_blue_concrete_stair.getRegistryName()),
                ItemList.lime_concrete_stair = new BlockItem(BlockList.lime_concrete_stair, new Item.Properties().group(ModName.JUNKTAB)).setRegistryName(BlockList.lime_concrete_stair.getRegistryName()),
                ItemList.red_concrete_stair = new BlockItem(BlockList.red_concrete_stair, new Item.Properties().group(ModName.JUNKTAB)).setRegistryName(BlockList.red_concrete_stair.getRegistryName()),
                ItemList.green_concrete_stair = new BlockItem(BlockList.green_concrete_stair, new Item.Properties().group(ModName.JUNKTAB)).setRegistryName(BlockList.green_concrete_stair.getRegistryName()),
                ItemList.yellow_concrete_stair = new BlockItem(BlockList.yellow_concrete_stair, new Item.Properties().group(ModName.JUNKTAB)).setRegistryName(BlockList.yellow_concrete_stair.getRegistryName()),
                ItemList.gray_concrete_stair = new BlockItem(BlockList.gray_concrete_stair, new Item.Properties().group(ModName.JUNKTAB)).setRegistryName(BlockList.gray_concrete_stair.getRegistryName()),
                ItemList.purple_concrete_stair = new BlockItem(BlockList.purple_concrete_stair, new Item.Properties().group(ModName.JUNKTAB)).setRegistryName(BlockList.purple_concrete_stair.getRegistryName()),
                ItemList.brown_concrete_stair = new BlockItem(BlockList.brown_concrete_stair, new Item.Properties().group(ModName.JUNKTAB)).setRegistryName(BlockList.brown_concrete_stair.getRegistryName()),
                ItemList.light_gray_concrete_stair = new BlockItem(BlockList.light_gray_concrete_stair, new Item.Properties().group(ModName.JUNKTAB)).setRegistryName(BlockList.light_gray_concrete_stair.getRegistryName()),
                ItemList.pink_concrete_stair = new BlockItem(BlockList.pink_concrete_stair, new Item.Properties().group(ModName.JUNKTAB)).setRegistryName(BlockList.pink_concrete_stair.getRegistryName()),
                ItemList.magenta_concrete_stair = new BlockItem(BlockList.magenta_concrete_stair, new Item.Properties().group(ModName.JUNKTAB)).setRegistryName(BlockList.magenta_concrete_stair.getRegistryName()),
